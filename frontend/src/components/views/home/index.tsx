 ...
 */
function stripXM(xmBytes: Uint8Array) {
 ...
 */
function compressSamples(samples: Uint8Array[]) {
...
function decompressSamples(compressedSmpsDict: SamplesDict) {
    const smpsDict = {};
 ...
 */
function compressXM(xmBytes: Uint8Array) {
    const deflator = new pako.Deflate();
 ...
 * Uses INFLATE
 */
function decompressXM(xmBytes: Uint8Array) {
    const inflator = new pako.Inflate();
...
function setSampleIDsInXM(xmBytes: Uint8Array, sampleIDs: string[]): void {
...
function reconstructXM(xmBytes: Uint8Array, smpsDict: SamplesDict): Uint8Array {
